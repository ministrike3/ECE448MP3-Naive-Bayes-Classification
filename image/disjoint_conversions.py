    ...
    for identifier in range(0,len(data)):
        ...
        for i in range(0,7):
            for j in range(0, 7):
                    new_array[i][j][0] = data[identifier][og_y][og_x]
                    new_array[i][j][1] = data[identifier][og_y][og_x+1]
                    new_array[i][j][2] = data[identifier][og_y][og_x+2]
                    new_array[i][j][3] = data[identifier][og_y][og_x+3]

                    new_array[i][j][4] = data[identifier][og_y+1][og_x]
                    new_array[i][j][5] = data[identifier][og_y+1][og_x+1]
                    new_array[i][j][6] = data[identifier][og_y+1][og_x+2]
                    new_array[i][j][7] = data[identifier][og_y+1][og_x+3]

                    new_array[i][j][8] = data[identifier][og_y+2][og_x]
                    new_array[i][j][9] = data[identifier][og_y+2][og_x+1]
                    new_array[i][j][10] = data[identifier][og_y+2][og_x+2]
                    new_array[i][j][11] = data[identifier][og_y+2][og_x+3]

                    new_array[i][j][12] = data[identifier][og_y+3][og_x]
                    new_array[i][j][13] = data[identifier][og_y+3][og_x+1]
                    new_array[i][j][14] = data[identifier][og_y+3][og_x+2]
                    new_array[i][j][15] = data[identifier][og_y+3][og_x+3]
    ...
    for identifier in range(0,len(data)):
        ...
        for i in range(0,7):
            for j in range(0, 14):
                    ...
                    new_array[i][j][4] = data[identifier][og_y+2][og_x]
                    new_array[i][j][5] = data[identifier][og_y+2][og_x+1]

                    new_array[i][j][6] = data[identifier][og_y+3][og_x]
                    new_array[i][j][7] = data[identifier][og_y+3][og_x+1]
